...
const About = () => {
  ...
  return (
    ...
    <div className="flex flex-col min-h-screen bg-dashboard bg-cover bg-no repeat">
      {/* Navbar */}
      ...
      <section classNameName="flex-grow flex w-full items-center justify-center px-50" >
        ...
        <div classNameName=" max-w-7xl mx-auto px-8 md:px-8 lg:px-16 xl:px-20 text-center">
          <div className='text-white mx-12 w-full text-center'>
            <p classNameName="text-white text-center md:text-lg">
              ...
              <br />Currently in our third year of undergraduate studies at SVIT, our collective passion and drive are focused on reshaping the way humanity explores the underwater realm.
              <br />
              Our journey has been guided by the invaluable expertise of our college alumnus, Arpit Shah, and his accomplished team. 
              <br />Their mentorship and support have played a pivotal role in propelling our remotely operated vehicle (ROV) towards unprecedented success.<br />
              With a shared vision and relentless determination, we are committed to pushing the boundaries of what is possible beneath the waves. <br />Together, we are not just students; we are innovators on a mission to revolutionize underwater exploration.
      ...
      <section >
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
          <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16">
            <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-200 ">Meet Our Team members</h2>

          </div>
          <div className="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3">
            <div className="text-center text-gray-500 dark:text-gray-400">
              <img className="mx-auto mb-4 w-35 h-36 rounded-full" src="/Arpit.jpg" alt="Arpit Avatar" />
              ...
              <ul className="flex justify-center mt-4 space-x-4">
                <li>
                  <a href="#" className="text-[#39569c] hover:text-gray-200 dark:hover:text-white">
                ...
                <li>
                  <a href="#" className="text-[#00acee] hover:text-gray-200 dark:hover:text-white">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" /></svg>
                  </a>
                </li>
                <li>
                  <a href="#" className="text-gray-200 hover:text-gray-200 dark:hover:text-white dark:text-gray-300">
                ...
                <li>
                  <a href="#" className="text-[#ea4c89] hover:text-gray-200 dark:hover:text-white">
            ...
            <div className="text-center text-gray-500 dark:text-gray-400">
              <img className="mx-auto mb-4 w-36 h-36 rounded-full" src="assets/image 2.png" alt="Helene Avatar" />
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-200 ">
            ...
            <div className="text-center text-gray-500 dark:text-gray-400">
              <img className="mx-auto mb-4 w-35 h-36 rounded-full" src="assets/IMG-20230201-WA0000.jpg" alt="Jese Avatar" />
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-200 ">
            ...
            <div className="text-center text-gray-500 dark:text-gray-400">
              <img className="mx-auto rounded-full h-36 w-35" src="assets/Isha.jpg" alt="Isha Avatar" />
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-200 ">
                <a href="#">Isha Shah</a>
              </h3>
            ...
            <div className="text-center text-gray-500 dark:text-gray-400">
              <img className="mx-auto mb-4 w-35 h-36 rounded-full" src="/dhyeya.png" alt="Leslie Avatar" />
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-200 ">
            ...
            <div className="text-center text-gray-500 dark:text-gray-400">
              <img className="mx-auto mb-4 w-35 h-36 rounded-full" src="/pranav.png" alt="Michael Avatar" />
              <h3 className="mb-1 text-2xl font-bold tracking-tight text-gray-200 ">
