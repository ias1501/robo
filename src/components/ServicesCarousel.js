...
const slides = [
  {
    ...
    imageUrl: 'https://www.lifehacker.com.au/wp-content/uploads/2022/08/11/0fdbc09e9747f05600d6608da9b9f7b6.jpg?resize=1024,576',
  },
  {
    title: 'WanderFloat',
      ...
      >
        {slides.map((slide, index) => (
          <div key={index} className="carousel-slide relative">
            ...
            />
            <div className="carousel-caption bg-gradient-to-t from-black to-transparent text-white p-4 absolute bottom-0 left-0 right-0 rounded-b-lg">
